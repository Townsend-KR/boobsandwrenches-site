      ...
      <div className="mx-auto max-w-6xl">
        <nav className="mb-10 flex flex-col items-center justify-between gap-5 px-2 py-4 md:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm font-semibold uppercase tracking-[0.18em]">
            <a href="#studio" className="text-[#9C7730] hover:text-[#E0C26B]">
              The Studio
            </a>

            <a href="#work" className="text-[#9C7730] hover:text-[#E0C26B]">
              Work
            </a>

            <Link
              href="/tools-for-sale"
              className="text-[#9C7730] hover:text-[#E0C26B]"
            >
              Tools
            </Link>

            <a href="#contact" className="text-[#9C7730] hover:text-[#E0C26B]">
              Contact
            </a>
          </div>
        </nav>
